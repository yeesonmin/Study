...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Qlayout_t, stringdata0) + ofs), len 
...
const QMetaObject Qlayout::staticMetaObject = { {
    ...
    qt_meta_stringdata_Qlayout.offsetsAndSize,
    qt_meta_data_Qlayout,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Qlayout_t
