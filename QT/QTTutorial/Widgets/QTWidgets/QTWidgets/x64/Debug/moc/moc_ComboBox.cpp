...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ComboBox_t, stringdata0) + ofs), len 
...
const QMetaObject ComboBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_ComboBox.offsetsAndSize,
    qt_meta_data_ComboBox,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ComboBox_t
