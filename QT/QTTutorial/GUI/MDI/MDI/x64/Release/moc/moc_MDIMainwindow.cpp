...
#include <memory>
#include "../../../../../../../../../QT_Example/Ch03/07_MDI/01_MDIMainWindow/MDIMainwindow.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MDIMainWindow_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_MDIMainWindow_t qt_meta_stringdata_MDIMainWindow = {
    {
QT_MOC_LITERAL(0, 13) // "MDIMainWindow"
...
const QMetaObject MDIMainWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_MDIMainWindow.offsetsAndSize,
    qt_meta_data_MDIMainWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MDIMainWindow_t
, QtPrivate::TypeAndForceComplete<MDIMainWindow, std::true_type>
