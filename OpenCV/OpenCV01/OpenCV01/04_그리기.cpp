...
//	arrowedLine(img, Point(50, 300), Point(350, 300), Scalar(255, 0, 0), 1, LINE_8, 0, 0.05);//0.05=>화살표 길이 비율값
//
...
//	putText(img, "FONT_HERSHEY_COMPLEX | FONT_ITALIC", Point(20, 450), FONT_HERSHEY_COMPLEX | FONT_ITALIC, 1, Scalar(255, 0, 0));//FONT_ITALIC 기울기
//
//	imshow("img", img);
//	waitKey();
//
