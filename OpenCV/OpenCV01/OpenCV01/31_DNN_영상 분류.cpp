...
//		img = imread("scooter.jpg", IMREAD_COLOR);
//	else
...
//	// Load network
//
//	Net net = readNet("bvlc_googlenet.caffemodel", "deploy.prototxt");//모델과 구성파일 읽기
//
//	if (net.empty()) {
...
//
//	// Inference
//	Mat inputBlob = blobFromImage(img, 1, Size(224, 224), Scalar(104, 117, 123));//구글넷에서 크기 224*224에 평균값 104,117,123을 빼서 학습함.
